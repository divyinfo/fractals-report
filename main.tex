...
\addto\extrasenglish{
	\renewcommand{\sectionautorefname}{Section \S}
	\let\subsectionautorefname\sectionautorefname
	\let\subsubsectionautorefname\sectionautorefname
}
...
In this thesis, for \gls{ui} three main overview techniques and two secondary preview techniques of the overviews are developed and implemented using the Mandelbrot set as the source of extreme resolution datasets. For these datasets, a hierarchical structure is used to present the index information of the current region of interest. Using the developed software in this thesis, it is possible to intuitively understand the hierarchical state of the current observing area with the whole. This thesis also compares the five different overview techniques.

It is worth mentioning that the Mandelbrot set that is implemented in this thesis is a very good example for extreme high resolution datasets because it is a dataset that can theoretically provide infinitely high resolution.
...
\newglossaryentry{h5}{name = {HTML5}, description = {Latest evolution of the standard that defines \textbf{HTML}}}
\newglossaryentry{css3}{name = {CSS3}, description = {In latest evolution of the standard that defines \textbf{HTML}, comes together with the extended \textbf{CSS}, which is often referred as CSS3}}
\newglossaryentry{map}{name = {Map}, description = {Overview + details, focus + context, mini-map or \textbf{minimap}}}
...
\newglossaryentry{fpc}{name = {F + C}, description = {Focus + context, overview + details, mini-map or \textbf{minimap}, same concept as the entry \textbf{Map}}}
\newglossaryentry{opd}{name = {O + D}, description = {Overview + details, focus + context, mini-map or \textbf{minimap}, same concept as the entry \textbf{Map}}}
