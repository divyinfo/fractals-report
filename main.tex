...
\university{\href{http://www.uni-due.com}{Universität Duisburg-Essen}} % Your university's name and URL, this is used in the title page and abstract, print it elsewhere with \univname
\department{\href{http://department.uni-due.com}{International Studies in Engineering (ISE) PO08}} % Your department's name and URL, this is used in the title page and abstract, print it elsewhere with \deptname
\group{\href{http://researchgroup.uni-due.com}{Computer Engineering}} % Your research group's name and URL, this is used in the title page, print it elsewhere with \groupname
\faculty{\href{http://faculty.uni-due.com}{Fakultät für Ingenieurwissenschaften}} % Your faculty's name and URL, this is used in the title page and abstract, print it elsewhere with \facname
...
International Studies in Engineering (ISE) PO08\\[0.3cm] % Research group name and department name
\textit{for the}\\[0.4cm]
